...
import { Text,Center,Heading, HStack, Stack, Link, VStack, UnorderedList, ListItem, StackDivider, Button} from "@chakra-ui/react";
...
const ResumeTemplate = (props) => {
  ...
  const capitalizedFirstName = resumeInfo.profile.firstname.toUpperCase();
  const capitalizedLastName = resumeInfo.profile.lastname.toUpperCase();

...
import { Box, VStack, Center, Heading, Progress, Stack, HStack } from "@chakra-ui/react";
  ...
  return (
    <Stack mb="50px">
      <Center
        ...
        flexDir="column"
      >
        <Heading p={4} color="darkviolet">
          Stand Out from the Crowd with Our Online Resume Builder{" "}
          <EditIcon boxSize={8} />
        </Heading>
        {/* <Box w="60%" borderRadius="lg" bg="white">
          <Progress
